...
def test_updateUserNormal(client):
    ...
    response2 = client.put('/user/user', json=data2)
...
def test_resetPasswordNormal(client):
    ...
    response2 = client.put('/user/updatePassword', json=data2)
    assert response2.status_code == 200
    ...
    response4 = client.put('/user/updatePassword', json=data4)
    ...
    response6 = client.put('/user/updatePassword', json=data6)
...
def test_resetPasswordAdmin(client):
    ...
    response4 = client.put('/user/updatePassword', json=data2)
    assert response4.status_code == 200
...
def test_makeAdmin(client):
    ...
    response1 = client.put('/user/makeAdmin', json=data2)
...
def test_deleteUser(client):
    ...
    response1 = client.put('/user/deleteUser', json=data2)
...
def test_desactivateUser(client):
    ...
    response1 = client.put('/user/desactivateUser', json=data2)
