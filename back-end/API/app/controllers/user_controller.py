...
def requestResetPassword():
    try:
        ...
        if user_service.getUser(data['email']):
            ...
            sendMail(data['email'], 'Demande de changement de mot de passe', 'Vous avez demandé un changement de mot de passe.<br> Si vous n\'avez pas fait cette requête, veuillez ignorer ce courriel.<br><a href="https://' + passwordResetLink + '" target="_blank">Appuyez</a>')
