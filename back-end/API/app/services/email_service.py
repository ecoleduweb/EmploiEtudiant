...
def sendMail(receiver_email, subject, content):
    ...
    try:
        ...
        # Send the email - corrected SMTP handling
        ...
        # You can also log to your application's logger
        current_app.logger.error(f"Failed to send email to {receiver_email}: {str(e)}")
        return False