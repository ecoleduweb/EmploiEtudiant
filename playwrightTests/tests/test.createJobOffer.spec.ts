...
test.describe('createNewJobOffer', () => {
  ...
  test('Ajouter un Offre', async ({ page }) => {
    ...
    await page.getByLabel('Heures/semaine*').fill('25');
    await page.getByLabel('Salaire Horaire (0.00)').click();
    await page.getByLabel('Salaire Horaire (0.00)').fill('21');
  ...
  test('Offre Invalide', async ({ page }) => {
    ...
    await page.getByRole('button', { name: 'Enregistrer' }).click();
    await page.getByLabel('Salaire Horaire (0.00)*').click();
    await page.getByLabel('Salaire Horaire (0.00)*').fill('asdd');
    await page.getByText('Veuillez entrer un salaire').click();
    await page.getByRole('button', { name: 'Enregistrer' }).click();
    await page.getByLabel('Salaire Horaire (0.00)*').click();
    await page.getByLabel('Salaire Horaire (0.00)*').fill('1.23');
    await page.getByText('Veuillez entrer un salaire').click();
    await page.getByRole('button', { name: 'Enregistrer' }).click();
    await page.getByLabel('Heures/semaine*').click();
    await page.getByLabel('Heures/semaine*').fill('asd');
    await page.getByRole('button', { name: 'Enregistrer' }).click();
    await page.getByLabel('Heures/semaine*').click();
    await page.getByLabel('Heures/semaine*').fill('23');
