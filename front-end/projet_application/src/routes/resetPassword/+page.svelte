<script lang="ts">
    ...
    let failedPopupMessage =
        "Impossible de changer le mot de passe, lien invalide ou expiré?"
            ...
            <ul class="list-requirements">
                {#if $validations.lowercase}
                    <li>
                        ...
                        <span class="text-password"
                            >Contient une lettre minuscule</span
                        >
                    </li>
                {:else}
                    <li>
                        ...
                        <span class="text-password"
                            >Ne contient pas de lettre minuscule</span
                        >
                    </li>
                {/if}
                ...
                {#if $validations.uppercase}
                    <li>
                        <span class="text-password-good">✔</span>
                        <span class="text-password"
                            >Contient une lettre majuscule</span
                        >
                    </li>
                {:else}
                    <li>
                        <span class="text-password-error">X</span>
                        <span class="text-password"
                            >Ne contient pas de lettre majuscule</span
                        >
                    </li>
                {/if}
                ...
                {:else}
                    <li>
                        <span class="text-password-error">X</span>
                        <span class="text-password"
                            >Ne contient pas de chiffre</span
                        >
                    </li>
                {/if}
                {#if $validations.specialChar}
                    <li>
                        <span class="text-password-good">✔</span>
                        <span class="text-password"
                            >Contient un caractère spécial</span
                        >
                    </li>
                {:else}
                    <li>
                        <span class="text-password-error">X</span>
                        <span class="text-password"
                            >Ne contient pas de caractère spécial</span
                        >
                    </li>
                {/if}
